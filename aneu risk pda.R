...
for (data.set.smoothed in list(FKS.fd, FKS.bs.smooth, FKS.f.smooth)) {
  ...
  set.seed(100)
  set.sm.RSQ.result <- RSQ.error(data.set.smoothed, label.sm, n.repeat=repeat.n, K.=nfold, max.order.=max.order.in, deriv.method.="fourier", nbasis.=41)
  set.sm.pda.result <- pda.score.error(data.set.smoothed, label.sm, n.repeat=repeat.n, K.=nfold, max.order.=max.order.in, deriv.method.="fourier", nbasis.=41)
...
# plot
input.data <- FKS.fd
input.data <- FKS.bs.smooth
input.data <- FKS.f.smooth
